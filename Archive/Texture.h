...
namespace vkex {
	...
	public:
		struct LoadInfo {
			std::vector<Texture2D::CreateInfo> texture2DInfos;
			std::vector<TextureCube::CreateInfo> textureCubeInfos;
			std::vector<TextureArray::CreateInfo> textureArrayInfos;
		};
