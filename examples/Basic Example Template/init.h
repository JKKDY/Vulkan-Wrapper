...
inline VkPipelineViewportStateCreateInfo pipelineViewportSatetCreateInfo(const VkViewport & viewport, const VkRect2D & scissor, VkPipelineViewportStateCreateFlags flags = 0) {
...
inline VkImageSubresourceRange imageSubresourceRange(VkImageAspectFlags ImageAspectFlags) {
